"""
Simple module for a cryptocurrency (Shincoin at port 5002)
"""
...
"""
A class that is used to build the blockchain.
"""
class Blockchain:
    def __init__(self):
        self.chain = []
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Billy', amount = 1)
